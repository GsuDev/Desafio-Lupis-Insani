...
class GameController extends Controller
{
    ...
    public function addMessageByGame(Request $req,$id)
    {
        $messages =[
            ...
            'user.required' => 'El campo "user" es requerido.',
            'user.string' => 'El campo "user" debe ser una cadena de texto o el id del usuario.',
        ...
        try{
            $game = Game::findOrFail($id);
            $game->addMessage($req->type, $req->user, $req->message);
